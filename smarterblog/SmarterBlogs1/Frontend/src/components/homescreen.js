...
class homescreen extends Component {
 ...
 return (
    ...
    <h1 align ="center"><a href="/search">Grafreez News</a><small>Get the latest News</small></h1>
    </div>
 ...
 <nav class="nav nav-inline"> <a href="#" class="nav-link"><span class="ping"></span><i class="fa fa-envelope-o"></i></a> <a href="#" class="nav-link"><i class="fa fa-bell-o"></i></a> <a href="#" class="nav-link"></a> </nav>
	...
	<div class="row">
        ...
        <div class="row justify-content-between">
          ...
          <input type="text" class="form-control input-lg" placeholder="Search for an article"/>
          <div>
          </div>
